...
export default function App() {
  ...
  return user ? (
    <>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '1rem', background: 'transparent' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '3rem', background: 'transparent' }}>
          
        </div>
        <div style={{ textAlign: 'right', background: 'transparent' }}>
          <span style={{ fontWeight: 'bold', color: 'white' }}>{user.email} </span>
    ...
    <div style={{ ...loginWrapperStyle, backgroundColor: 'transparent' }}>
      <div style={{ ...loginBoxStyle, backgroundColor: 'transparent', boxShadow: 'none' }}>
